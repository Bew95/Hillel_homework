print('Hello Worlds')
print('Hello Worlds' * 5)


#########################################
# Соблюдение РЕР8. Неправильние отступы
print('Hello World')
if 1==1:
    print('Hello World')
...
int_ = 123
print('int_: ', int_)
print('type(int_): ', type(int_))
c = 2
d = int_ * c
print('d', d)
string_number = '123'
string_number1 = 2
sd = string_number * string_number1
print('sd: ', sd)
...
print('type(ls_data): ', type(ls_data))
ls_data = list((1, 2, 3, 4))
print('ls_data: ', ls_data)
print('type(ls_data): ', type(ls_data))
tuple_data = (1, 2, 3, 4)
df = list(tuple_data)
...
##############################################
# зменяемые неизменяемые типы данных
